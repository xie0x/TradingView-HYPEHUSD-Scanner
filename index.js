...
const formatReadme = (data) => {
  ...
  formattedReadme.push('# TradingView HYPEHUSD Scanner (1H)')
  ...
  formattedReadme.push('HYPEHUSD (Hyperliquid) recommendation scanner based on real-time TradingView data Scanner API')
